...
class Html2Text {
	...
	public static function convert($html, $ignore_error = false) {
	    ...
	    $ret = static::getDom($html, $ignore_error);

		return static::convertDOM($ret["doc"], $ret["is_office_document"]);
	}
     ...
     * @param boolean $is_office_document
     * @return string the HTML converted, as best as possible, to text
     */
    public static function convertDOM($doc, $is_office_document = false, $cloneDom = false) {
     ...
     * @throws Html2TextException if the HTML could not be loaded as a {@link \DOMDocument}
     */
    public static function getDom($html, $ignore_error = false) {
        ...
        return array("doc" => $doc, "is_office_document" => $is_office_document);
    }
